 ...
 */
public class ListarAnunciosAtivos extends javax.swing.JDialog {

    /**
     * Creates new form ListarAnuncios
     */
    public ListarAnunciosAtivos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarAnunciosAtivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListarAnunciosAtivos dialog = new ListarAnunciosAtivos(new javax.swing.JFrame(), true);
