 ...
 * @author vitor
 */
public class CadastroCompradorUI extends javax.swing.JDialog {
    ...
    private void confirmarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButtonActionPerformed
        ...
        Comprador comprador = new Comprador(null, nome, email, senha, cpf);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroCompradorUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroCompradorUI dialog = new CadastroCompradorUI(new javax.swing.JFrame(), true);
